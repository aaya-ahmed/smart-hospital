...
@Component({
  ...
  styleUrls: [
    '../../styles/addingform.css',
    '../../shared/sidehosttemplate/sidehost.component.css',
  ],
})
    ...
    switch (component) {
      ...
      case 'updateDoctor':
        this.currentComponent =
          this.viewrefrence.createComponent(AdddoctorComponent);
        break;
      case 'addNurse':
      case 'updateNurse':
        this.currentComponent =
          this.viewrefrence.createComponent(AddnurseComponent);
        break;
      case 'addEmployee':
      case 'updateEmployee':
        this.currentComponent =
          this.viewrefrence.createComponent(AddemployeeComponent);
        break;
      case 'addDepartment':
      case 'updateDepartment':
        this.currentComponent = this.viewrefrence.createComponent(
          AdddepartmentComponent
        );
        break;
      case 'addBed':
        this.currentComponent =
          this.viewrefrence.createComponent(AddbedComponent);
        break;
      case 'showNurse':
        this.currentComponent =
          this.viewrefrence.createComponent(ShownurseComponent);
        break;
      case 'showDoctor':
        this.currentComponent =
          this.viewrefrence.createComponent(ShowdoctorComponent);
        break;
      case 'addSchedule':
        this.currentComponent =
          this.viewrefrence.createComponent(SetScheduleComponent);
        break;
      case 'updateSchedule':
        this.currentComponent = this.viewrefrence.createComponent(
